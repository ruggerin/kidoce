<div class="leftbar">
    ...
    <div class="sidebar">
        <!-- Start Logobar -->
        <div class="logobar">
            <a href="{{url('/')}}" class="logo logo-large"><img src="orbiter/images/logo.svg" class="img-fluid" alt="logo"></a>
            <a href="{{url('/')}}" class="logo logo-small"><img src="orbiter/images/small_logo.svg" class="img-fluid" alt="logo"></a>
        </div>
        <!-- End Logobar -->
        <!-- Start Navigationbar -->
            ...
            <ul class="vertical-menu">
                <li>
                    <a href="javaScript:void();">
                      <img src="orbiter/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Dashboard</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="orbiter/images/svg-icon/layouts.svg" class="img-fluid" alt="layouts"><span>Layouts</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{url('/')}}">Light - Vertical</a></li> 
                        <li><a href="{{url('/../light-horizontal')}}">Light - Horizontal</a></li>
                        <li><a href="{{url('/../semi-dark-vertical')}}">Semi Dark - Vertical</a></li>
                        <li><a href="{{url('/../light-boxed-vertical')}}">Boxed - Vertical</a></li>
                        <li><a href="{{url('/../rtl/light-vertical')}}">RTL</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javaScript:void();">
                        <img src="orbiter/images/svg-icon/basic.svg" class="img-fluid" alt="basic"><span>Basic UI</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="orbiter/images/svg-icon/advanced.svg" class="img-fluid" alt="advanced"><span>Advanced UI</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">                                
                ...
                <li>
                    <a href="javaScript:void();">
                      <img src="orbiter/images/svg-icon/apps.svg" class="img-fluid" alt="apps"><span>Apps</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="orbiter/images/svg-icon/form_elements.svg" class="img-fluid" alt="form_elements"><span>Forms</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="orbiter/images/svg-icon/chart.svg" class="img-fluid" alt="chart"><span>Charts</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="orbiter/images/svg-icon/icons.svg" class="img-fluid" alt="icons"><span>Icons</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="orbiter/images/svg-icon/tables.svg" class="img-fluid" alt="tables"><span>Tables</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="orbiter/images/svg-icon/maps.svg" class="img-fluid" alt="maps"><span>Maps</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="{{url('/widgets')}}">
                        <img src="orbiter/images/svg-icon/widgets.svg" class="img-fluid" alt="widgets"><span>Widgets</span><span class="badge badge-success pull-right">New</span>
                    </a>
                </li>                        
                <li>
                    <a href="javaScript:void();">
                      <img src="orbiter/images/svg-icon/pages.svg" class="img-fluid" alt="pages"><span>Pages</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li>
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="orbiter/images/svg-icon/ecommerce.svg" class="img-fluid" alt="ecommerce"><span>eCommerce</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
