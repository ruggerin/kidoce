...
<html lang="en">
    <head>
        ...
        <!-- Start CSS -->   
        @yield('style')
        <link href="{{ asset('orbiter/plugins/switchery/switchery.min.css') }}" rel="stylesheet" type="text/css">
    ...
    <body class="vertical-layout">
        ...
        <script src="{{ asset('orbiter/js/vertical-menu.js') }}"></script> 
        <script src="{{ asset('orbiter/plugins/switchery/switchery.min.js') }}"></script> 
        @yield('script')
        <!-- Core JS -->
        <script src="{{ asset('orbiter/js/core.js') }}"></script>
        <!-- End JS -->
    </body>
</html>    