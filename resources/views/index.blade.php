...
@section('style')
<!-- Apex css -->
<link href="{{ asset('orbiter/plugins/apexcharts/apexcharts.css') }}" rel="stylesheet" type="text/css" />
<!-- Slick css -->
<link href="{{ asset('orbiter/plugins/slick/slick.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('orbiter/plugins/slick/slick-theme.css') }}" rel="stylesheet" type="text/css" />
@endsection 
                            ...
                            <div class="avatar-group">
                                <div class="avatar">
                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                        <img src="orbiter/images/users/men.svg" alt="avatar" class="rounded-circle">
                                    </a>
                                </div>
                                <div class="avatar">
                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                        <img src="orbiter/images/users/women.svg" alt="avatar" class="rounded-circle">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card-body text-center">
                            <div class="user-slider">
                                <div class="user-slider-item">
                                    <img src="orbiter/images/users/men.svg" alt="avatar" class="rounded-circle mt-3 mb-4">
                                    <h5>James Smith</h5>
                                    <p>Senior Sales Executive</p>
                                    <p>55 Avenue, North Street Road, Carolina State, New York City, USA</p>
                                </div>
                                <div class="user-slider-item">
                                    <img src="orbiter/images/users/women.svg" alt="avatar" class="rounded-circle mt-3 mb-4">
                                    <h5>James Smith</h5>
                                    <p>Senior Sales Executive</p>
                                    <p>55 Avenue, North Street Road, Carolina State, New York City, USA</p>
                                </div>
                                <div class="user-slider-item">
                                    <img src="orbiter/images/users/girl.svg" alt="avatar" class="rounded-circle mt-3 mb-4">
                                    <h5>James Smith</h5>
                                    <p>Senior Sales Executive</p>
                                    <p>55 Avenue, North Street Road, Carolina State, New York City, USA</p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="orbiter/images/users/men.svg" class="img-fluid" width="35" alt="customer"></td>
                                            <td>John Doe</td>
                                        ...
                                        <tr>
                                            <td><img src="orbiter/images/users/women.svg" class="img-fluid" width="35" alt="customer"></td>
                                            <td>Daniel Chris</td>
                                            <td>demo@example.com</td>
                                            <td>93%</td>
                                            <td>1300</td>
                                        ...
                                        <tr>
                                            <td><img src="orbiter/images/users/boy.svg" class="img-fluid" width="35" alt="customer"></td>
                                            <td>John Joshua</td>
                                            <td>demo@example.com</td>
                                            <td>87%</td>
                                            <td>1250</td>
...
@section('script')
<!-- Apex js -->
<script src="{{ asset('orbiter/plugins/apexcharts/apexcharts.min.js') }}"></script>
<script src="{{ asset('orbiter/plugins/apexcharts/irregular-data-series.js') }}"></script>
<!-- Slick js -->
<script src="{{ asset('orbiter/plugins/slick/slick.min.js') }}"></script>
<!-- Custom Dashboard js -->  
<script src="{{ asset('orbiter/js/custom/custom-dashboard.js') }}"></script>
@endsection 