...
<div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                <h2>Tabela<small>Vendedores</small></h2>
                ...
                <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{$rca->nome}}</td>
                        <td>{{$rca->nomedeguerra}}</td>
                        @if($rca->ativo=="1")
                        <td><a  style="color:#01DF3A;"><i class="fa fa-circle"></i>Ativo</a></td>
                        @else
                        <td><a  style="color:#FF0000;"><i class="fa fa-circle"></i>Inativo</a></td>
                        @endif
                        <td>{{$rca->ult_sinc}}</td>
