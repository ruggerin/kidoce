            ...
            <div class="body">
                ...
                <div class="table-responsive ">
                    <table class="table table-bordered table-striped table-hover js-table dataTable">
                        ...
                        <tbody>
                        @foreach($tipoprodutos as $tipoprod)
                        <tr>
                            {{-- <td><a href="{{route('rca.edit', $rca->codrca)}}">{{$rca->codrca}}</a></td>--}}
                            <td>{{$tipoprod->tipoprodid}}</td>
                            <td>{{$tipoprod->descricao}}</td>
                            <td>
                                <a href="#" onclick="showFormEditar({{ $tipoprod->tipoprodid}})" >
                                    <i class="material-icons">mode_edit</i>
                                </a>
                                <a href="{{route('lojas.edit',$tipoprod->tipoprodid)}}" >
